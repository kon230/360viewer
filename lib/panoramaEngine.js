  ...
  _attachInputHandlers() {
    ...
    window.addEventListener('pointermove', (e) => {
      if (this._draggedMarkerId) {
        // Marker positions are fixed: pointer movement while a marker is
        // pressed is tracked only to distinguish a real click (fires
        // markerClick on pointerup) from an incidental drag, never to
